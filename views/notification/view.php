            ...
            <div class="boxed-group">
                ...
                <ul class="boxed-group-inner list-group notifications">
                    ...
                    <li class="list-group-item">
                        <a href="<?= Url::toRoute(['topic/view', 'id' => $userMention->topic_id]) ?>"><strong><?= $userMention->topic->subject ?></strong></a> <a href="<?= Url::toRoute(['post/view', 'id' => $userMention->post_id, '#' => 'p' . $userMention->post_id]) ?>">#<?= $userMention->post_id ?></a>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </div>
